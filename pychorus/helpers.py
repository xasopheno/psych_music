...
def find_chorus(chroma, sr, song_length_sec, clip_length):
    ...
    return (best_chorus.start / chroma_sr, best_chorus.end / chroma_sr)
...
def find_and_output_chorus(input_file, output_file, clip_length=15):
    ...
    chorus_start, chorus_end = find_chorus(chroma, sr, song_length_sec, clip_length)
    ...
    if output_file is not None:
        ...
        print(chorus_start)
        chorus_end = 10
        os.system('ffmpeg -ss {} -t {} -i {} {}'.format(str(chorus_start), str(chorus_end), input_file, output_file))
